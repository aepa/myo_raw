...
import roslib; roslib.load_manifest('myo_ros')
import rospy
...
class MyoRaw(object):
    ...
    def __init__(self, tty=None):
        ...
        exercise_topic = rospy.get_param('~exercise_topic', '/exercise')   
        self.pub = rospy.Publisher(exercise_topic, UInt8, queue_size=10)
        #rospy.spin()
